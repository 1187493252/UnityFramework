...
public class SetBtnSelectedStateTMPro : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    [Header("父节点,不可空")]
    ...
    public void SetOthersNormalState(bool executeEvent = false)
    {
        ...
        SetBtnSelectedStateTMPro[] tmp = root.GetComponentsInChildren<SetBtnSelectedStateTMPro>();

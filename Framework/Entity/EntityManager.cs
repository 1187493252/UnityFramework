    ...
    internal sealed partial class EntityManager : FrameworkModule, IEntityManager
    {
        ...
        internal override void Update(float elapseSeconds, float realElapseSeconds)
        {
            while (m_RecycleQueue.Count > 0)
            {
                ...
                if (entityGroup == null)
                {
                    throw new FrameworkException("Entity group is invalid.");
                }
        ...
        public bool HasEntityGroup(string entityGroupName)
        {
            ...
            {
                throw new FrameworkException("Entity group name is invalid.");
            }
        ...
        public bool AddEntityGroup(string entityGroupName, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority, IEntityGroupHelper entityGroupHelper)
        {
            ...
            {
                throw new FrameworkException("Entity group helper is invalid.");
            }
        ...
        public void ShowEntity(int entityId, string entityAssetName, string entityGroupName, int priority, object userData)
        {
            ...
            {
                throw new FrameworkException("You must set entity helper first.");
            }
            ...
            {
                throw new FrameworkException(Utility.Text.Format("Entity id '{0}' is already exist.", entityId.ToString()));
            }

            if (IsLoadingEntity(entityId))
            {
                throw new FrameworkException(Utility.Text.Format("Entity '{0}' is already being loaded.", entityId.ToString()));
            }

            EntityGroup entityGroup = (EntityGroup)GetEntityGroup(entityGroupName);
            if (entityGroup == null)
            {
                throw new FrameworkException(Utility.Text.Format("Entity group '{0}' is not exist.", entityGroupName));
            }
        ...
        public void HideEntity(int entityId, object userData)
        {
            ...
            if (entityInfo == null)
            {
                throw new FrameworkException(Utility.Text.Format("Can not find entity '{0}'.", entityId.ToString()));
            }
        ...
        public void HideEntity(IEntity entity, object userData)
        {
            if (entity == null)
            {
                throw new FrameworkException("Entity is invalid.");
            }
        ...
        public IEntity GetParentEntity(int childEntityId)
        {
            ...
            {
                throw new FrameworkException(Utility.Text.Format("Can not find child entity '{0}'.", childEntityId.ToString()));
            }
        ...
        public IEntity GetParentEntity(IEntity childEntity)
        {
            if (childEntity == null)
            {
                throw new FrameworkException("Child entity is invalid.");
            }
        ...
        public int GetChildEntityCount(int parentEntityId)
        {
            ...
            {
                throw new FrameworkException(Utility.Text.Format("Can not find parent entity '{0}'.", parentEntityId.ToString()));
            }
        ...
        public IEntity GetChildEntity(IEntity parentEntity)
        {
            ...
            {
                throw new FrameworkException("Parent entity is invalid.");
            }
        ...
        public void AttachEntity(int childEntityId, int parentEntityId, object userData)
        {
            ...
            {
                throw new FrameworkException(Utility.Text.Format("Can not attach entity when child entity id equals to parent entity id '{0}'.", parentEntityId.ToString()));
            }
            ...
            {
                throw new FrameworkException(Utility.Text.Format("Can not attach entity when child entity status is '{0}'.", childEntityInfo.Status.ToString()));
            }
            ...
            {
                throw new FrameworkException(Utility.Text.Format("Can not attach entity when parent entity status is '{0}'.", parentEntityInfo.Status.ToString()));
            }
        ...
        public void DetachEntity(int childEntityId, object userData)
        {
            ...
            if (parentEntityInfo == null)
            {
                throw new FrameworkException(Utility.Text.Format("Can not find parent entity '{0}'.", parentEntity.Id.ToString()));
            }
        ...
        private void InternalShowEntity(int entityId, string entityAssetName, EntityGroup entityGroup, object entityInstance, bool isNewInstance, float duration, object userData)
        {
            try
            {
                ...
                if (entity == null)
                {
                    throw new FrameworkException("Can not create entity in entity helper.");
                }
        ...
        private void InternalHideEntity(EntityInfo entityInfo, object userData)
        {
            ...
            {
                throw new FrameworkException("Entity info is unmanaged.");
            }
        ...
        private void LoadAssetSuccessCallback(string entityAssetName, object entityAsset, float duration, object userData)
        {
            ...
            {
                throw new FrameworkException("Show entity info is invalid.");
            }

...
namespace Framework.UI
{
    internal sealed partial class UIManager : FrameworkModule, IUIManager
    {
        ...
        public void SetUIFormHelper(IUIFormHelper uiFormHelper)
        {
            ...
            {
                throw new FrameworkException("UI form helper is invalid.");
            }
        ...
        {
            return AddUIGroup(uiGroupName, 0, 0, uiGroupHelper);
        }
        ...
        /// <param name="uiGroupRenderMode">界面组RenderMode。</param>
        /// <param name="uiGroupHelper">界面组辅助器。</param>
        /// <returns>是否增加界面组成功。</returns>
        public bool AddUIGroup(string uiGroupName, int uiGroupDepth, int uiGroupRenderMode, IUIGroupHelper uiGroupHelper)
        {
            if (string.IsNullOrEmpty(uiGroupName))
            {
                throw new FrameworkException("UI group name is invalid.");
            ...
            {
                throw new FrameworkException("UI group helper is invalid.");
            }
            ...
            m_UIGroups.Add(uiGroupName, new UIGroup(uiGroupName, uiGroupDepth, uiGroupRenderMode, uiGroupHelper));
        ...
        public int[] GetAllLoadingUIFormIds()
        {
            int index = 0;
        ...
        public void GetAllLoadingUIFormIds(List<int> results)
        {
            if (results == null)
            {
                throw new FrameworkException("Results is invalid.");
        ...
        {
            return m_UIFormsBeingLoaded.ContainsKey(uiFormId);
        }
        ...
        public void OpenUIForm(int uiFormId, string uiFormAssetName, string uiGroupName, int priority, bool pauseCoveredUIForm, object userData)
        {
            ...
            {
                throw new FrameworkException("You must set UI form helper first.");
            }
            ...
            if (uiGroup == null)
            {
                throw new FrameworkException(Utility.Text.Format("UI group '{0}' is not exist.", uiGroupName));
            }

            if (HasUIForm(uiFormId))
            {
                throw new FrameworkException(Utility.Text.Format("UIForm id '{0}' is already exist.", uiFormId.ToString()));
            }

            if (IsLoadingUIForm(uiFormId))
            {
                throw new FrameworkException(Utility.Text.Format("UIForm '{0}' is already being loaded.", uiFormId.ToString()));
            }
            ...
            InternalOpenUIForm(uiFormId, uiFormAssetName, uiGroup, uiFormInstanceObject.Target, pauseCoveredUIForm, false, 0f, userData);
        ...
        public void CloseUIForm(int serialId, object userData)
        {
            ...
            if (uiForm == null)
            {
                throw new FrameworkException(Utility.Text.Format("Can not find UI form '{0}'.", serialId.ToString()));
            }
        ...
        public void CloseUIForm(IUIForm uiForm, object userData)
        {
            ...
            {
                CloseUIFormCompleteEventArgs closeUIFormCompleteEventArgs = CloseUIFormCompleteEventArgs.Create(uiForm.Id, uiForm.UIFormAssetName, uiGroup, userData);
        ...
        private void InternalOpenUIForm(int uiFormId, string uiFormAssetName, UIGroup uiGroup, object uiFormInstance, bool pauseCoveredUIForm, bool isNewInstance, float duration, object userData)
        {
            try
            {
                ...
                if (uiForm == null)
                {
                    throw new FrameworkException("Can not create UI form in UI form helper.");
                }

                uiForm.OnInit(uiFormId, uiFormAssetName, uiGroup, pauseCoveredUIForm, isNewInstance, userData);
            ...
            catch (Exception exception)
            {
                ...
                {
                    OpenUIFormFailureEventArgs openUIFormFailureEventArgs = OpenUIFormFailureEventArgs.Create(uiFormId, uiFormAssetName, uiGroup.Name, pauseCoveredUIForm, exception.ToString(), userData);
        ...
        private void LoadAssetSuccessCallback(string uiFormAssetName, object uiFormAsset, float duration, object userData)
        {
            ...
            if (m_UIFormsToReleaseOnLoad.Contains(openUIFormInfo.Id))
            {
                m_UIFormsToReleaseOnLoad.Remove(openUIFormInfo.Id);
                ReferencePool.Release(openUIFormInfo);
                m_UIFormHelper.ReleaseUIForm(uiFormAsset, null);
                return;
            }

            m_UIFormsBeingLoaded.Remove(openUIFormInfo.Id);
            ...
            InternalOpenUIForm(openUIFormInfo.Id, uiFormAssetName, openUIFormInfo.UIGroup, uiFormInstanceObject.Target, openUIFormInfo.PauseCoveredUIForm, true, duration, openUIFormInfo.UserData);
        ...
        private void LoadAssetFailureCallback(string uiFormAssetName, LoadResourceStatus status, string errorMessage, object userData)
        {
            ...
            if (m_OpenUIFormFailureEventHandler != null)
            {
                OpenUIFormFailureEventArgs openUIFormFailureEventArgs = OpenUIFormFailureEventArgs.Create(openUIFormInfo.Id, uiFormAssetName, openUIFormInfo.UIGroup.Name, openUIFormInfo.PauseCoveredUIForm, appendErrorMessage, openUIFormInfo.UserData);
                m_OpenUIFormFailureEventHandler(this, openUIFormFailureEventArgs);
                ReferencePool.Release(openUIFormFailureEventArgs);
                return;
            }
        ...
        private void LoadAssetUpdateCallback(string uiFormAssetName, float progress, object userData)
        {
            ...
            {
                OpenUIFormUpdateEventArgs openUIFormUpdateEventArgs = OpenUIFormUpdateEventArgs.Create(openUIFormInfo.Id, uiFormAssetName, openUIFormInfo.UIGroup.Name, openUIFormInfo.PauseCoveredUIForm, progress, openUIFormInfo.UserData);
        ...
        private void LoadAssetDependencyAssetCallback(string uiFormAssetName, string dependencyAssetName, int loadedCount, int totalCount, object userData)
        {
            ...
            {
                OpenUIFormDependencyAssetEventArgs openUIFormDependencyAssetEventArgs = OpenUIFormDependencyAssetEventArgs.Create(openUIFormInfo.Id, uiFormAssetName, openUIFormInfo.UIGroup.Name, openUIFormInfo.PauseCoveredUIForm, dependencyAssetName, loadedCount, totalCount, openUIFormInfo.UserData);

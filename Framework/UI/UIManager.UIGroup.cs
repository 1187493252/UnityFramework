...
namespace Framework.UI
{
    internal sealed partial class UIManager : FrameworkModule, IUIManager
    {
        ...
        private sealed partial class UIGroup : IUIGroup
        {
            ...
            private readonly FrameworkLinkedList<UIFormInfo> m_UIFormInfos;
            ...
            public UIGroup(string name, int depth, int renderMode, IUIGroupHelper uiGroupHelper)
            {
                ...
                m_UIFormInfos = new FrameworkLinkedList<UIFormInfo>();
                m_CachedNode = null;
                Depth = depth;
                m_RenderMode = renderMode;
                uiGroupHelper.SetRenderMode(m_RenderMode);
            }
            ...
            public bool HasUIForm(int serialId)
            {
                ...
                {
                    if (uiFormInfo.UIForm.Id == serialId)
                    {
                        return true;
                    }
                }
            ...
            public void RemoveUIForm(IUIForm uiForm)
            {
                ...
                if (uiFormInfo == null)
                {
                    throw new FrameworkException(Utility.Text.Format("Can not find UI form info for serial id '{0}', UI form asset name is '{1}'.", uiForm.Id.ToString(), uiForm.UIFormAssetName));
                }
                ...
                {
                    throw new FrameworkException(Utility.Text.Format("UI group '{0}' not exists specified UI form '[{1}]{2}'.", m_Name, uiForm.Id.ToString(), uiForm.UIFormAssetName));
                }
            ...
            public void RefocusUIForm(IUIForm uiForm, object userData)
            {
                ...
                if (uiFormInfo == null)
                {
                    throw new FrameworkException("Can not find UI form info.");
                }

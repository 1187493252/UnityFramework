...
namespace Framework.UI
{
    ...
    public interface IUIManager
    {
        ...
        /// <param name="uiGroupHelper">界面组辅助器。</param>
        /// <returns>是否增加界面组成功。</returns>
        bool AddUIGroup(string uiGroupName, int uiGroupDepth, int uiGroupRenderMode, IUIGroupHelper uiGroupHelper);

        /// <summary>
        /// 是否存在界面。
        /// </summary>
        /// <param name="uiFormId">界面序列编号。</param>
        ...
        int[] GetAllLoadingUIFormIds();

        /// <summary>
        /// 获取所有正在加载界面的序列编号。
        /// </summary>
        /// <param name="results">所有正在加载界面的序列编号。</param>
        void GetAllLoadingUIFormIds(List<int> results);
        ...
        bool IsLoadingUIForm(int uiFormId);
        ...
        /// <param name="uiFormAssetName">界面资源名称。</param>
        /// <param name="uiGroupName">界面组名称。</param>
        void OpenUIForm(int uiFormId, string uiFormAssetName, string uiGroupName);
        ...
        void OpenUIForm(int uiFormId, string uiFormAssetName, string uiGroupName, int priority);
        ...
        void OpenUIForm(int uiFormId, string uiFormAssetName, string uiGroupName, bool pauseCoveredUIForm);
        ...
        void OpenUIForm(int uiFormId, string uiFormAssetName, string uiGroupName, object userData);
        ...
        /// <param name="priority">加载界面资源的优先级。</param>
        /// <param name="pauseCoveredUIForm">是否暂停被覆盖的界面。</param>
        void OpenUIForm(int uiFormId, string uiFormAssetName, string uiGroupName, int priority, bool pauseCoveredUIForm);
        ...
        /// <param name="priority">加载界面资源的优先级。</param>
        /// <param name="userData">用户自定义数据。</param>
        void OpenUIForm(int uiFormId, string uiFormAssetName, string uiGroupName, int priority, object userData);
        ...
        /// <param name="pauseCoveredUIForm">是否暂停被覆盖的界面。</param>
        /// <param name="userData">用户自定义数据。</param>
        void OpenUIForm(int uiFormId, string uiFormAssetName, string uiGroupName, bool pauseCoveredUIForm, object userData);
        ...
        /// <param name="pauseCoveredUIForm">是否暂停被覆盖的界面。</param>
        /// <param name="userData">用户自定义数据。</param>
        void OpenUIForm(int uiFormId, string uiFormAssetName, string uiGroupName, int priority, bool pauseCoveredUIForm, object userData);

        /// <summary>
        /// 关闭界面。
        /// </summary>
        /// <param name="uiFormId">要关闭界面的序列编号。</param>
        void CloseUIForm(int uiFormId);

...
namespace Framework.WebRequest
{
    ...
    public sealed class WebRequestSuccessEventArgs : FrameworkEventArgs
    {
        ...
        public static WebRequestSuccessEventArgs Create(int serialId, string webRequestUri, byte[] webResponseBytes, string webResponseText, object userData)
        {
            ...
            webRequestSuccessEventArgs.m_WebResponseText = webResponseText;

...
namespace Framework.WebRequest
{
    ...
    internal sealed partial class WebRequestManager : FrameworkModule, IWebRequestManager
    {
        ...
        private sealed class WebRequestAgent : ITaskAgent<WebRequestTask>
        {
            ...
            public FrameworkAction<WebRequestAgent> WebRequestAgentStart;
            public FrameworkAction<WebRequestAgent, byte[], string> WebRequestAgentSuccess;
            public FrameworkAction<WebRequestAgent, string> WebRequestAgentFailure;
            ...
            public WebRequestAgent(IWebRequestAgentHelper webRequestAgentHelper)
            {
                ...
                {
                    throw new FrameworkException("Web request agent helper is invalid.");
                }
            ...
            private void OnWebRequestAgentHelperComplete(object sender, WebRequestAgentHelperCompleteEventArgs e)
            {
                ...
                {
                    WebRequestAgentSuccess(this, e.GetWebResponseBytes(), e.GetWebResponseText());
                }

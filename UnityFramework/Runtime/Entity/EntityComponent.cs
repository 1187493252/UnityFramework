...
namespace UnityFramework.Runtime
{
    ...
    public sealed partial class EntityComponent : UnityFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_EntityHelperTypeName = "UnityFramework.Runtime.DefaultEntityHelper";

        [SerializeField]
        private EntityHelperBase m_CustomEntityHelper = null;

        [SerializeField]
        private string m_EntityGroupHelperTypeName = "UnityFramework.Runtime.DefaultEntityGroupHelper";
        ...
        {
            m_EntityManager.HideEntity(entityLogic.Entity);
        }
        ...
        private void OnShowEntitySuccess(object sender, Framework.Entity.ShowEntitySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntitySuccessEventArgs.Create(e));
        }

        private void OnShowEntityFailure(object sender, Framework.Entity.ShowEntityFailureEventArgs e)
        {
        ...
        private void OnShowEntityUpdate(object sender, Framework.Entity.ShowEntityUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntityUpdateEventArgs.Create(e));
        }

        private void OnShowEntityDependencyAsset(object sender, Framework.Entity.ShowEntityDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntityDependencyAssetEventArgs.Create(e));
        }

        private void OnHideEntityComplete(object sender, Framework.Entity.HideEntityCompleteEventArgs e)
        {

...
namespace UnityFramework.Runtime
{
    ...
    /// 声音代理辅助器基类。
    /// </summary>
    public abstract class AudioAgentHelperBase : MonoBehaviour, IAudioAgentHelper
    {
        ...
        /// 重置声音代理事件。
        /// </summary>
        public abstract event EventHandler<ResetAudioAgentEventArgs> ResetAudioAgent;
        ...
        public abstract bool SetAudioAsset(object soundAsset);

/*
* FileName:          UnityWebRequestAgentHelper
* CompanyName:       
* Author:            relly
* Description:       
*/
...
namespace UnityFramework.Runtime
{
    ...
    public class UnityWebRequestAgentHelper : WebRequestAgentHelperBase, IDisposable
    {
        ...
        public override void Request(string webRequestUri, object userData)
        {
            ...
            if (wwwFormInfo.Headers != null && wwwFormInfo.Headers.Count > 0)
            {
                foreach (var item in wwwFormInfo.Headers)
                {
        ...
        public override void Request(string webRequestUri, byte[] postData, object userData)
        {
            ...
            //    m_UnityWebRequest = UnityWebRequest.Post(webRequestUri, Framework.Utility.Converter.GetString(postData));
        ...
        private void Update()
        {
            ...
            {
                WebRequestAgentHelperCompleteEventArgs webRequestAgentHelperCompleteEventArgs = WebRequestAgentHelperCompleteEventArgs.Create(m_UnityWebRequest.downloadHandler.data, m_UnityWebRequest.downloadHandler.text);

...
namespace UnityFramework.Runtime.Task
{
    ...
    public abstract class ToolInteractable : MonoBehaviour
    {
        ...
        private void HandHoverUpdate(Hand hand)
        {
            ...
            //Debug.LogError(hand);
            OnHover_(hand);
            //Debug.LogError(VRHandHelper.Instance.VRInput_GrabPinch.GetKeyDown(hand));
            //扳机按下 握持 松开
            ...
            //    OnPressUp_(hand);
            //}
            //Debug.LogError(SteamVR_Actions._default.GrabPinch.GetStateUp(SteamVR_Input_Sources.Any));
